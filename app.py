...
def main():
    ...
    with tab2:
        ...
        if 'result' not in st.session_state:
            ...
            if st.button("🚀 Generate Formal Meeting Minutes", type="primary"):
    ...
    if 'result' in st.session_state and 'notulen' in st.session_state:
        ...
        st.divider()
        st.subheader("📋 Meeting Summary Results")
...
"""
            ...
            if st.button("🗑️ Clear Basic Results"):
    ...
    if 'ai_notulen' in st.session_state:
        ...
        with col2:
            ...
            if st.button("🗑️ Clear AI Results"):
                if 'ai_notulen' in st.session_state:
